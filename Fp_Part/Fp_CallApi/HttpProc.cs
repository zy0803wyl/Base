...
namespace Fp_Part
{
    ...
    internal class WebClient
    {
        ...
        internal event EventHandler<UploadEventArgs> UploadProgressChanged;
        internal event EventHandler<DownloadEventArgs> DownloadProgressChanged;
        static WebClient()
        {
            LoadCookiesFromDisk();
        }
        ...
        internal void DownloadFile(string url, string filename)
        {
            FileStream fs = null;
            try
            {
        ...
        /// <param name="url">网址</param>    
        /// <returns></returns>    
        internal byte[] GetData(string url)
        {
            HttpWebRequest request = CreateRequest(url, "GET");
        ...
        /// <returns></returns>    
        internal string Post(string url, byte[] postData)
        {
        ...
        /// <returns></returns>    
        internal string Post(string url, MultipartForm mulitpartForm)
        {
            HttpWebRequest request = CreateRequest(url, "POST");
    ...
    internal class MultipartForm
    {
        ...
        internal void AddFlie(string name, string filename)
        {
        ...
        internal void AddFlie(string name, string filename, byte[] fileData, int dataLength)
        {
